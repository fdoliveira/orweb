<footer>
	...
	<div class="bg-light py-5">
		<div class="text-center text-capitalize text-secondary">
	    	&copy; <script>document.write(new Date().getFullYear())</script> ORPDV - Todos os direitos reservados. Design pela equipe do ORPDV.
	    </div>
	</div>	
</footer>
...
<script src="inc/js/coreNavigation-1.1.3.min.js"></script>
