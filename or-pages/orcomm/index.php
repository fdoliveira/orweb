...
<header class="h-100-vh bg-danger">
	<div class="container">
		<div class="min-h-100-vh d-flex align-items-center justify-content-center">

			<div class="text-center text-white">
				<h1 class="font-weight-bold text-uppercase display-4">orCOMM</h1>
				<h2 class="h4 font-weight-light">Sistema completo para varejo</h2>
...
<section class="py-5">
	<div class="container my-5">
		...
		<div class="row justify-content-center">
			...
			<div class="col-md-3">
				...
				<div class="card bg-light mb-3 py-4">
	  				<div class="card-body text-center text-md-left">
	    				<h5 class="card-title text-danger h4 font-weight-bold">Benefício <?= $i; ?></h5>
			...
			<a class="btn btn-lg btn-danger mt-4" href="">Agregar Valor ao Produto</a>
...
<section>
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-6 bg-danger" style="height: 540px;">
			...
			<div class="col-md-6" style="height: 540px;">
				<div class="h-100 d-flex align-items-center justify-content-center">
					<div class="w-100 text-center text-md-left mx-md-5 ">
						...
						<a class="btn btn-lg btn-danger mt-4" href="">Depoimentos Clientes</a>
					</div>
				</div>
			</div>
		</div>
...
<section class="py-5">
	<div class="container my-5">
    	...
    	<div class="row justify-content-center">
					...
					<div class="card-header py-5">
	  				...
	  				<div class="card-body py-4">
	  					<div class="d-flex justify-content-center align-items-center">
			    			<figure class="mb-0">
								<img class="rounded-circle border border-danger" src="http://articlebio.com/uploads/bio/2016/08/05/taylor-marie-hill.jpg" height="85" width="85">
			    			</figure>
			    			<div class="ml-2">
			    				<h5 class="h6 text-uppercase text-danger font-weight-bold mb-1">Fulano de Tal</h5>
			...
			<a class="btn btn-lg btn-danger mt-4" href="">Planos</a>
				...
				<div class="card-deck text-center mt-2">
				    <div class="card">
				    	...
				    	<div class="card-body">
				        	...
				        	<button type="button" class="btn btn-lg btn-block btn-outline-danger">Assine Grátis</button>
				    	</div>
					</div>
				</div>
				...
				<div class="card-deck text-center">
				    <div class="card">
				    	<div class="card-header py-3">
				        	<h4 class="h3 my-0 text-uppercase text-danger">Padrão</h4>
				    	</div>
				    	<div class="card-body py-4">
				...
				<div class="card-deck text-center mt-2">
				    <div class="card">
				    	...
				    	<div class="card-body">
				        	...
				        	<button type="button" class="btn btn-lg btn-block btn-danger">Assine Agora</button>
				    	</div>
					</div>
				</div>
